...
if(isset($_POST['email']) || isset($_POST['senha'])) {
    ...
    // que hackers acessem essa senha, deixando o banco menos vunerável.
        ...
        $sql_code = "SELECT * FROM loginn WHERE email = '$email' AND senha = '$senha'";
        ...
        if($quantidade == 1) {
            ...
            // se a quantidade de registos for 0
...
<body>
    ...
    // Criacao do formulario com o metodo POST para grande quantidade de dados
    // action vazia para que os dados vao para a propria pagina login. php
